...
int main()
{
    ...
    // be 15.
    char data[15];
    int n = 0, option = 0, count_n = 0;     //n=no of data, count_n=no of lines in example.txt
    // This is the initial mark alloted to a subject.
    string empty = "00";
    string proctor = "";
    // Name of the file in which DB is stored.
    ifstream f("Example.txt");   //read the example.txt file
    string line;
    ...
    while (option != 6) {
        ...
        if (option == 1) {
            ...
            for (int i = 0; i < n; i++) {
                ofstream outfile;   //write into outfile  object  ,outfile is sililar to cout as outfile is use to cout data from example.txt file
            ...
            ifstream infile;
            int check = 0;
            infile.open("Example.txt", ios::in);   //infile is use to read and write both
